                ...
                <div class="modal-body">
                  <div class="container">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" required class="form-control" name="price" id="" aria-describedby="helpId" placeholder="">
                      </div>
                      <div class="form-group">
                            <label for="">Quantity</label>
                            <input type="number" required class="form-control" name="quantity" id="" aria-describedby="helpId" placeholder="">
                      </div>
                  </div>
                </div>
                <!-- Modal footer -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                         ...
                         <td>
                            <a class="btn btn-info btn-sm"  href="admin/edit/{{ $p->id }}">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                    Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="admin/delete/{{ $p->id }}">
