<div class="card">
   ...
   @endif
    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <input type="number" min="1" max="100" required value="" class="form-control" name="discount" id="discount" aria-describedby="helpId" placeholder="">
              </div>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <div class="form-group">
                <label for="">Limited</label>
                <input type="number" min="1" max="100" required value="" class="form-control" name="limited" id="limited" aria-describedby="helpId" placeholder="">
              </div>
        </div>
    ...
    <button type="submit" id="add" style="float: right" class="btn btn-primary">Add</button>
    </form>
</div>
</div>
